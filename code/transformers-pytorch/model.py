...
class FeedForwardBlock(nn.Module):
    ...
    def __init__(self, d_model: int, d_ff: int, dropout: float) -> None:
        super().__init__()
        self.linear_1 = nn.Linear(d_model, d_ff) # W1 and B1, bias is by default present
        self.dropout = nn.Dropout(dropout)
        self.linear_3 = nn.Linear(d_ff, d_model) # W2 and B2
...
def build_transformer(
    ...
    for _ in range(N):
        ...
        feed_forward_block = FeedForwardBlock(d_model=d_model, d_ff=d_diff, dropout=dropout)
